               ...
               <table class="table">
                    ...
                    <tbody>
                         ...
                         <tr>
                              ...
                              <td><?= $row['username'] ?></td>
                              <td>
                                  <a href="edit-user.php?user_id=<?=$row['id'] ?>" class="btn-outline-warning btn-sm"><i class="fa-solid fa-pen"></i></a>
                                  <form action="../actions/delete-user.php" method="post" class="d-inline ms-2">
                                        <input type="hidden" name="user_id" value="<?=$row['id']?>">
                                        <button type="submit" class="btn btn--sm btn-outline-danger"><i class="fa-solid fa-fresh"></i></button></form>
                              </td>
                         </tr>
                         <?php } ?>
                    </tbody>
